...
const recoilDistance = 30; // Distance du recul horizontal
const recoilSpeed = 0.5;
...
function updatePaddles() {
    ...
    if (paddleRecoilLeft <= 0) {
        leftPaddleX = 45;  // Réinitialiser la position horizontale du paddle gauche
    }
    ...
    if (paddleRecoilRight <= 0) {
        rightPaddleX = canvas.width - paddleWidth - 45;  // Réinitialiser la position horizontale du paddle droit
    }
