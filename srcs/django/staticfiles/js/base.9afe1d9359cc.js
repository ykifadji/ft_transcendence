...
document.addEventListener('DOMContentLoaded', () => {
    ...
    bgVideo.src = savedTheme ? bgBasePath + savedTheme : defaultBg;
        ...
        if (themeOptions.length > 0) {
            ...
            if (st) {
                themeOptions.forEach(to => {
                    if (to.getAttribute('data-video') === st) {
            ...
            themeOptions.forEach(thOpt => {
                thOpt.addEventListener('click', () => {
                    ...
                    console.log('Selected theme:', chosenVideo);
                });
            });
        }
    }
            ...
            if (section === 'themes') {
                ...
                themesGrid.addEventListener('click', (e) => {
                    ...
                    if (themeOption && themeOption.getAttribute('data-video')) {
                        ...
                        localStorage.setItem('selectedTheme', chosenVideo);
                    }
                });
            }
