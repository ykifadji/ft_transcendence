...
function updatePaddles() {
    ...
    if (paddleRecoilLeft <= 0 && leftPaddleX < 45) {
        leftPaddleX += recoilSpeed;  // Réinitialiser la position horizontale du paddle gauche
    }
    ...
    if (paddleRecoilRight <= 0 && rightPaddleX > canvas.width - paddleWidth - 45 ) {
        rightPaddleX -= recoilSpeed;  // Réinitialiser la position horizontale du paddle droit
    }
